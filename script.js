window.addEventListener("load", () => {
    ...
    class Player {
        ...
        draw(context){
            ...
            spriteWidth, this.frameY * this.spriteHeight, this.
    ...
    class Obstacle {
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.
            spriteWidth, this.frameY * this.spriteHeight, this.
            spriteWidth, this.spriteHeight, this.spriteX, this.
    ...
    class Egg {
        ...
        draw(context){
            ...
            if(this.game.debug){
                ...
                context.fillText(displayTimer, this.collisionX, this.collisionY - this.
                collisionRadius * 2.5);
            }
        }
        cute(deltaTime){
            ...
            //hatching
            if(this.hatchTimer > this.hatchInterval || this.
                collisionY < this.game.topMargin){
    ...
    class Larva {
        constructor(game, x, y){
            ...
            this.frameX = 0;
            this.frameY = Math.floor(Math.random() * 2);//picture larva 1 and 2 but in counting 0-1
        }
        draw(context){
            context.drawImage(this.image, this.frameX * this.
                spriteWidth, this.frameY * this.spriteHeight, this.
        ...
        cute(){
            ...
            if(this.collisionY < this.game.topMargin){
                ...
                for ( let i = 0; i < 3; i++){
                    ...
                    game, this.collisionX, this.collisionY, 'yellow'));
                }
            }
            ...
            this.game.enemies.forEach(enemy => {
                if(this.game.checkCollision(this, enemy)[0]){
                    ...
                    for ( let i = 0; i < 3; i++){
                        this.game.particles.push(new Spark(this.
                        game, this.collisionX, this.collisionY, 'white'));
                    }
                }
            });  
        }
    ...
    class Enemy {
        ...
        draw(context){
            ...
            this.frameY * this.spriteHeight, this.
            spriteWidth, this.spriteHeight, this.
            spriteX, this.spriteY, this.width, this.height);
            if(this.game.debug){
                context.beginPath();
                context.arc(this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 2);
                context.save();
    ...
    class Game {
        ...
        render(context, deltaTime){
            ...
            if(this.score >= this.winningScore){
                ...
                let message1;
                let message2;
                if(this,this.lostHatchlings <= 5){
                    message1 = "Amazing!";
                    message2 = "You're a pro!";
                } else {
                    message1 = "Defeated";
                    message2 = "Need more practice!" + this.
                    lostHatchlings + "Try again.";
                }
                context.font = '130px Cabin';
                context.fillText(message1, this.width * 0.5, this.height * 0.5 - 20);
                context.font = '40px Cabin';
                context.fillText(message2, this.width * 0.5, this.height * 0.5 + 30);
                context.fillText("Final score " + this.score + 
                ". Press 'R' to but heads again!", this.width * 0.5, this.height * 0.5 + 80);
                context.restore();
            }
        }
        checkCollision(a, b){
        ...
        init(){
            ...
            while(this.obstacles.length < this.numberOfObstacles && attempts < 500){
                ...
                if(!overlap && testObstacle.spriteX > 0 && 
                    ...
                    this.topMargin + margin && testObstacle.collisionY < this.height - margin){
